...
if __name__ == "__main__":
    ...
    parser.add_argument('--ranged_mode', action="store_true", help="If this flag is enabled, instead of sampling the plan length at random, go thtough all values in range, increasing by 1 per step.")
    ...
    parser.add_argument('--min_action_size', type=int, default=3, help="Minimum action size that is allowed to be generated. Useful when dealing with a randomly distributed action size.")
    ...
    # Initialise length variable for when using the ranged_mode flag.
